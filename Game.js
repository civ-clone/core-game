...
class Game {
    ...
    constructor(adopted = {}) {
        ...
        this.additionalData = (_e = adopted.additionalData) !== null && _e !== void 0 ? _e : new AdditionalDataRegistry_1.AdditionalDataRegistry();
        ...
        this.availableCityBuildItems = (_j = adopted.availableCityBuildItems) !== null && _j !== void 0 ? _j : new AvailableCityBuildItemsRegistry_1.AvailableCityBuildItemsRegistry();
        this.availableGovernments = (_k = adopted.availableGovernments) !== null && _k !== void 0 ? _k : new AvailableGovernmentRegistry_1.AvailableGovernmentRegistry();
        this.availableTerrainFeatures = (_l = adopted.availableTerrainFeatures) !== null && _l !== void 0 ? _l : new AvailableTerrainFeatureRegistry_1.AvailableTerrainFeatureRegistry();
        this.availableTradeRates = (_m = adopted.availableTradeRates) !== null && _m !== void 0 ? _m : new AvailableTradeRateRegistry_1.AvailableTradeRateRegistry();
        ...
        this.cityImprovements = (_r = adopted.cityImprovements) !== null && _r !== void 0 ? _r : new CityImprovementRegistry_1.CityImprovementRegistry();
        ...
        this.playerGovernments = (_3 = adopted.playerGovernments) !== null && _3 !== void 0 ? _3 : new PlayerGovernmentRegistry_1.PlayerGovernmentRegistry();
        this.playerResearch = (_4 = adopted.playerResearch) !== null && _4 !== void 0 ? _4 : new PlayerResearchRegistry_1.PlayerResearchRegistry();
        this.players = (_5 = adopted.players) !== null && _5 !== void 0 ? _5 : new PlayerRegistry_1.PlayerRegistry();
        this.playerTradeRates = (_6 = adopted.playerTradeRates) !== null && _6 !== void 0 ? _6 : new PlayerTradeRatesRegistry_1.PlayerTradeRatesRegistry();
        this.playerTreasuries = (_7 = adopted.playerTreasuries) !== null && _7 !== void 0 ? _7 : new PlayerTreasuryRegistry_1.PlayerTreasuryRegistry();
        ...
        this.terrainFeatures = (_12 = adopted.terrainFeatures) !== null && _12 !== void 0 ? _12 : new TerrainFeatureRegistry_1.TerrainFeatureRegistry();
        this.terrains = (_13 = adopted.terrains) !== null && _13 !== void 0 ? _13 : new TerrainRegistry_1.TerrainRegistry();
        this.tileImprovements = (_14 = adopted.tileImprovements) !== null && _14 !== void 0 ? _14 : new TileImprovementRegistry_1.TileImprovementRegistry();
        ...
        this.unitImprovements = (_17 = adopted.unitImprovements) !== null && _17 !== void 0 ? _17 : new UnitImprovementRegistry_1.UnitImprovementRegistry();
        ...
        this.workedTiles = (_20 = adopted.workedTiles) !== null && _20 !== void 0 ? _20 : new WorkedTileRegistry_1.WorkedTileRegistry(this.rules);
